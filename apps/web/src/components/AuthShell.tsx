...
export function AuthShell({ children, heading, subheading }: AuthShellProps) {
  return (
    <main className="min-h-screen bg-[#f4f7f5] text-overload-ink lg:grid lg:grid-cols-[minmax(360px,0.85fr)_minmax(0,1.15fr)]">
      <section className="flex min-h-[260px] flex-col justify-between bg-overload-ink px-6 py-8 text-white lg:min-h-screen lg:px-10">
        <div>
        ...
        <div className="mt-8 grid max-w-lg grid-cols-2 gap-3 text-sm text-white/78">
          <div className="rounded-lg border border-white/10 bg-white/5 p-4">
            <p className="text-2xl font-semibold text-white">30d</p>
            <p className="mt-1">Analytics range</p>
          </div>
          <div className="rounded-lg border border-white/10 bg-white/5 p-4">
            <p className="text-2xl font-semibold text-white">JWT</p>
            <p className="mt-1">API sessions</p>
          </div>
        </div>
      </section>
